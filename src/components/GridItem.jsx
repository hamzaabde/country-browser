...
export default function GridItem({ flags, name, alpha3Code, ...details }) {
	return (
		<Link
			className="rounded-lg mx-6 xs:max-w-[420px] sm:max-w-auto xs:mx-auto flex flex-col overflow-hidden items-stretch transition bg-white dark:bg-dark-blue shadow-md"
			to={`/${alpha3Code}`}
		>
